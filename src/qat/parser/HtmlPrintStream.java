...
public class HtmlPrintStream extends PrintStream {
	...
	if (htmlMode)
	    originalStream.print("<font color=\""+color+"\">"+s+"</font>");
	else
	...
	if (htmlMode)
	    originalStream.println(x+BREAK);
	else
	...
	if (htmlMode)
	    originalStream.println(s+BREAK);
	else
	...
	if (htmlMode)
	    originalStream.println("<font color=\""+color+"\">"+s+"</font><br>");
	else
	    originalStream.println(s);
    }
	...
	if (htmlMode)
	    originalStream.println("<b>"+s+"</b><br>");
	else
	    originalStream.println(s);
    }
